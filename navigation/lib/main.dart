...
import './app_screens/pass_args_demo.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      onGenerateRoute: (settings) {
        // If you push the PassArguments aroute
        ...
        // The assertion here will help remind us of that higher up
        // in the call stack, since this assertion would otherwise fire
